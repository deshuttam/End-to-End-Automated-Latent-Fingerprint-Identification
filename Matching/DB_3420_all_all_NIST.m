...
myFolder = 'F:\PhD\Software\Matlab\Simple_FingerPrint_Matching\NIST SD27\FpMV Enhanced\Image';
...
cd  'F:\PhD\Software\Matlab\Simple_FingerPrint_Matching\NIST SD27\FpMV Enhanced\Image';
filePattern = fullfile(myFolder, '*.bmp');
jpegFiles   = dir(filePattern);

fid=fopen('FengAEQueryGallerySkeleton.txt','wt');
Query='Query';
Gallery='Gallery';
Score='Score';
fprintf(fid,'%s \t %s \t %s\n',Query,Gallery,Score); 
sheet=1;
xlfilename='FingerNetAEQueryGalleryFengAE.xlsx';
