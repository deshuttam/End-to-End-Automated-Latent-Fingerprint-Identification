...
function [ ret] = ext_finger_FVC2004(img, display_flag,filename)
...
% Enhancement -------------------------------------------------------------
    ...
    [ binim, mask, cimg, cimg2, orient_img, orient_img_m ] = f_enhance(img,filename);
   %[ binim, mask, cimg, cimg2, orient_img, orient_img_m ] = f_enhance_fvc2004(img,filename);
% Making Mask -------------------------------------------------------------
