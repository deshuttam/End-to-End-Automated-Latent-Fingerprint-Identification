...
myFolder = 'F:\PhD\Software\Matlab\Simple_FingerPrint_Matching\NIST SD27\Feng Skeleton\image';
...
files = dir('F:\PhD\Software\Matlab\Simple_FingerPrint_Matching\NIST SD27\Feng Skeleton\image\*.bmp');
%cd  'F:\PhD\Software\Matlab\Simple_FingerPrint_Matching\Manualskeleton\xlsx';
...
build_datab_skeleton(2);
load('dbskeleton.mat');

%% EXTRACT FEATURES FROM AN ARBITRARY FINGERPRINT

for k = 1:1 %length(file_names)
